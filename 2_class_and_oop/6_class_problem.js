...
class Country{
    CountryName;
    CountryGroupInfo;
    constructor(CountryName,CountryGroupInfo){
        this.CountryName=CountryName;
        this.CountryGroupInfo=CountryGroupInfo;
    }
}
...
class IdolGroup{
    IdolGroupName;
    IdolGroupInfo;
    constructor(IdolGroupName,IdolGroupInfo){
        this.IdolGroupName = IdolGroupName;
        this.IdolGroupInfo =IdolGroupInfo;
    }
}
...
class Idol{
    IdolName;
    IdolYear;
    constructor(IdolName,IdolYear) {
        this.IdolName= IdolName;
        this.IdolYear=IdolYear;
    }
}
...
const iveGroup  = iveMembers.map(x=> new FemaleIdol(x.name, x.year));
console.log(iveGroup);


const btsGroup = btsMembers.map(x=> new MaleIdol(x.name, x.year));
console.log(btsGroup);

const iveGroupInfo  =  new IdolGroup(
    '아이브',
    iveGroup,
)

const btsGroupInfo = new IdolGroup(
    '방탄소년단',
    btsGroup,
)

console.log(iveGroupInfo);
console.log(btsGroupInfo);
